...
type FxInfo struct {
	...
	AsOf             *timestamp.Timestamp `protobuf:"bytes,4,opt,name=as_of,json=asOf,proto3" json:"as_of,omitempty"`                                       // date/time the rate was taken for
...
func (x *FxInfo) GetAsOf() *timestamp.Timestamp {
	if x != nil {
		return x.AsOf
	}
	return nil
