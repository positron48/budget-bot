...
type FxRate struct {
	...
	AsOf             *timestamp.Timestamp `protobuf:"bytes,4,opt,name=as_of,json=asOf,proto3" json:"as_of,omitempty"`
...
func (x *FxRate) GetAsOf() *timestamp.Timestamp {
	if x != nil {
		return x.AsOf
	}
	return nil
...
type GetRateRequest struct {
	...
	AsOf             *timestamp.Timestamp `protobuf:"bytes,3,opt,name=as_of,json=asOf,proto3" json:"as_of,omitempty"` // date at which to get the rate (truncate to day server-side if needed)
}
...
func (x *GetRateRequest) GetAsOf() *timestamp.Timestamp {
	if x != nil {
		return x.AsOf
	}
	return nil
...
type BatchGetRatesRequest struct {
	...
	ToCurrencyCode    string               `protobuf:"bytes,2,opt,name=to_currency_code,json=toCurrencyCode,proto3" json:"to_currency_code,omitempty"`
	AsOf              *timestamp.Timestamp `protobuf:"bytes,3,opt,name=as_of,json=asOf,proto3" json:"as_of,omitempty"`
}
...
func (x *BatchGetRatesRequest) GetAsOf() *timestamp.Timestamp {
	if x != nil {
		return x.AsOf
	}
	return nil
