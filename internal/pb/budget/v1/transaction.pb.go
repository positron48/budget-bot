...
func (x *Transaction) GetOccurredAt() *timestamp.Timestamp {
	if x != nil {
		return x.OccurredAt
	}
	return nil
...
func (x *CreateTransactionRequest) GetOccurredAt() *timestamp.Timestamp {
	if x != nil {
		return x.OccurredAt
	}
	return nil
...
type UpdateTransactionRequest struct {
	...
	UpdateMask  *field_mask.FieldMask `protobuf:"bytes,3,opt,name=update_mask,json=updateMask,proto3" json:"update_mask,omitempty"` // paths relative to Transaction (e.g. "category_id,amount,comment,occurred_at")
}
...
func (x *UpdateTransactionRequest) GetUpdateMask() *field_mask.FieldMask {
	if x != nil {
		return x.UpdateMask
	}
	return nil
