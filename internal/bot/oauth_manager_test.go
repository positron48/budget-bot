...
// Failing auth client for testing error scenarios
type failingAuthClient struct{}

func (f *failingAuthClient) Register(_ context.Context, _, _, _ string) (string, string, string, string, time.Time, time.Time, error) {
	return "", "", "", "", time.Time{}, time.Time{}, fmt.Errorf("register failed")
}

func (f *failingAuthClient) Login(_ context.Context, _, _ string) (string, string, string, string, time.Time, time.Time, error) {
	return "", "", "", "", time.Time{}, time.Time{}, fmt.Errorf("login failed")
}

func (f *failingAuthClient) RefreshToken(_ context.Context, _ string) (string, string, time.Time, time.Time, error) {
	return "", "", time.Time{}, time.Time{}, fmt.Errorf("refresh failed")
}
