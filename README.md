...
- `/clear_categories` - очистка всех пользовательских категорий:
  - Удаляет все категории, добавленные пользователем
  - Показывает количество удаленных категорий расходов и доходов
  - Не затрагивает категории в таблице
